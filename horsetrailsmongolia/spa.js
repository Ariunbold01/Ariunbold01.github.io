...
const aboutData = {
    "imageurl":"horsetrailsmongolia/images/abouts_us.png",
    "title":"ABOUT US",
...
const HOT_TREKS_DATA = {
    ...
    "Description":"Discover the hidden beauty of nature on horseback",
        "slide":[
            ...
            {"img_url":"horsetrailsmongolia/images/type_img2.jpg","title":"Horse Trekking in Northern Mongolia","Description":"The Lake  Khovsgol National Park where is inhabited by many nomads herding families. Here, man and nature exist side by side in the balance that has remained essentially unchanged for thousands of years","style":""},
            {"img_url":"horsetrailsmongolia/images/type_img3.jpg","title":"Gobi Desert Central Mongolian Tour","Description":"The Central Mongolian trip will offer you both cultural and adventure tours. Highlights of this trip will be Mongolia’s oldest Monastery ErdeneZuuHiid and Mongolian Wild horses, legendary Gobi desert..","style":""},
...
const SERVICES_DATA = {
    "image_url":"horsetrailsmongolia/images/service.png",
    "image_name":"service",
    "Title":"Our services",
    ...
    "Articles":[
        ...
        {
            id:2,
            "image_url":"horsetrailsmongolia/images/service2.png",
        ...
        {
            id:3,
            "image_url":"horsetrailsmongolia/images/service3.png",
        ...
        {
            id:4,
            "image_url":"horsetrailsmongolia/images/service4.png",
            "image_name":"BOOKING",
            "Title":"BOOKING",
...
const POPULAR_DATA = {
    "image_url":"horsetrailsmongolia/images/popular_icon.png",
    "title":"POPULAR TREKS",
...
//Route list
SPA.AddRoute("/", "/", home);
SPA.AddRoute("/", "/horsetrailsmongolia/", start);
...
SPA.OnRoute("/horsetrailsmongolia/");
